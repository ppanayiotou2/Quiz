...
function pluginInit(editor) {
    ...
    editor.addCommand('addlayout',
        new CKEDITOR.dialogCommand('addLayoutDialog' + editor.name, {
            allowedContent: allowedContent
        }));

    editor.addCommand('managelayout',
        new CKEDITOR.dialogCommand('manageLayoutDialog' + editor.name, {
            allowedContent: allowedContent
        }));
...
LayoutManager.prototype.manageLayoutDialog = function () {
    ...
    var layouts = this.generateButtonObjects(this.changeLayoutAction.bind({
        widget: this.editor.layoutmanager.selectedWidget
    }));
                    ...
                    defaultButtons: {
                        edit: {
                            onClick: function () {
                                ...
                                this.editor.execCommand('managelayout');
                            }
                        }
                    }
                }
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template(
        '<div class="container-fluid layout-container">\
             <div class="row layout-row" >\
                 <div class="layout-column-one col-xs-{size1} col-sm-{size1} col-md-{size1} col-lg-{size1} layout-column">\
                    <p></p>\
                </div>\
            </div>\
        </div>'
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template(
        '<div class="container-fluid layout-container">\
            <div class="row layout-row">\
                 ...
                 <div class="layout-column-two col-xs-{size2} col-sm-{size2} col-md-{size2} col-lg-{size2} layout-column">\
                    <p></p>\
                 </div>\
            </div>\
        </div>'
    ...
    defaultLayoutTemplates.push(new CKEDITOR.template(
        '<div class="container-fluid layout-container">\
            <div class="row layout-row">\
                ...
                <div class="layout-column-three col-xs-{size3} col-sm-{size3} col-md-{size3} col-lg-{size3} layout-column">\
                    <p></p>\
                </div>\
            </div>\
        </div>'
